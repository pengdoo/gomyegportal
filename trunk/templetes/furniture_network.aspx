                    ...
                    <div class="contentmain">
                        <div class="contenttitle">
                            <div class="sitemap">
                                ...
                                您的位置 ： 
                                <a href="/furniture/default.aspx">首页</a> &gt  <span><!--% Response.Output GCMS.Channel("CName")%--></span>
                            </div>
                ...
                <div id="innersidebar">
                    ...
                    <div class="submenu">
                        <div class="submenutitle">
                            <span class="sidenum">03</span>
                            <span class="sidetitle">营销网络</span>
                        </div>
                        <ul><!--%
i = GCMS.Channel("ChannelID")
For Each Channels In GCMS.GetChannels(10)
