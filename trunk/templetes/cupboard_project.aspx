                    ...
                    <div class="contentmain">
                        <div class="contenttitle">
                            <div class="sitemap">
                                ...
                                您的位置 ： 
                                <a href="/cupboard/default.aspx">首页</a> &gt <a href="/cupboard/project.aspx">工程介绍</a> &gt <span><!--% Response.Output GCMS.Channel("CName")%--></span>
                            </div>
                ...
                <div id="innersidebar">
                    ...
                    <div class="submenu">
                        <div class="submenutitle">
                            ...
                            <span class="sidetitle">工程介绍</span>
                        </div>
                        <ul><!--%
i = GCMS.Channel("ChannelID")
For Each Channels In GCMS.GetChannels(11)
