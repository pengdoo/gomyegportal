                    ...
                    <div class="contentmain">
                        <div class="contenttitle">
                            <div class="sitemap">
                                ...
                                您的位置 ： 
                                <a href="/group/default.aspx">首页</a> &gt <span><!--% Response.Output GCMS.Channel("CName")%--></span>
                            </div>
                ...
                <div id="innersidebar">
                    ...
                    <div class="submenu">
                        <div class="submenutitle">
                            <span class="sidenum">05</span>
                            <span class="sidetitle">华鹤文化</span>
                        </div>
                        <ul><!--%
i = GCMS.Channel("ChannelID")
For Each Channels In GCMS.GetChannels(53)
