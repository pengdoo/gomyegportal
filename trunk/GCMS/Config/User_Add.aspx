<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Add.aspx.cs" Inherits="Config_User_Add" %>
		...
		<form id="Form1" method="post" runat="server">
			<table border="0" width="100%" class="coolBar" cellspacing="1" cellpadding="0">
				<tr>
					...
					<cc3:Toolsbar id="Toolsbar1" OnButtonClick="Toolsbar1_ButtonClick" runat="server" AltText=" 保 存" Text=" 保 存" Width="55" imageNormal="../Admin_Public/Images/Icon_File_Save.gif"></cc3:Toolsbar>
					<TD></TD>
				</tr>
			</table>
