<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_Main.aspx.cs" Inherits="Config_Config_Main" %>
				...
				<tr HEIGHT="15">
					<td height="100%" vAlign="top">
						<div style="BORDER-RIGHT: navy 0px solid; PADDING-RIGHT: 0px; BORDER-TOP: navy 0px solid; OVERFLOW-Y: scroll; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; BORDER-LEFT: navy 0px solid; WIDTH: 100%; PADDING-TOP: 0px; BORDER-BOTTOM: navy 0px solid; HEIGHT: 100%"><span id="TypeTree_Label1">
								...
								<div class="parent" id="m1Parent"><IMG src="../Admin_Public/Images/Tree_white.gif" align="absMiddle" border="0"><span onmouseup="OpenFolder('m1','Config_MailAdd.aspx','COLUMN_1');" onmouseover="IsonMouseOver('m1');"
										onmouseout="IsonMouseOut('m1');"><IMG src="../admin_public/images/closedfolder.gif" align="absMiddle" border="0" name="m1Pic">&nbsp;<A class="item" href="#nothisanchor" name="m1Folder">&nbsp;邮件发送设置</A></span>
								</div>
