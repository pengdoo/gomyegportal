<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_ChannelView.aspx.cs" Inherits="Content_Config_ChannelView" %>
	...
	function fixSize(){
			scrollDiv.style.height=Math.max(document.body.clientHeight-100,0);
							...
							<DIV class="listView" id="ContentList" align="center">
								<asp:datagrid id="xpTable" runat="server" AutoGenerateColumns="false" OnItemDataBound="ItemDataBound"
									...
									<Columns>
										...
										<asp:BoundColumn HeaderText="扩展字段名称" HeaderStyle-CssClass="submitdate"></asp:BoundColumn>
									</Columns>
								</asp:datagrid>
							</DIV>
						</DIV>
						...
						<div id="menu1" onclick="clickMenu()" onmouseover="toggleMenu()" onmouseout="toggleMenu()"
							class="menu">
							<div class="menuItem" id="newUser" doFunction="doNewUser();">新增扩展字段类</div>
							<div class="menuItem" id="delUser" doFunction="doDelFile();">删除扩展字段类</div>
							<hr>
