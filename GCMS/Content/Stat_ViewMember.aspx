<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stat_ViewMember.aspx.cs" Inherits="Content_Stat_ViewMember" %>
...
function dragLeave(){
	...
	<body leftMargin="0" topMargin="0" scroll="no">
		<FORM id="Form1" method="post" runat="server">
			...
			<asp:panel id="Mapped" runat="server">
				<TABLE class="coolBar" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" border="0">
					<TR>
						<TD width="5"><SPAN class="handbtn"></SPAN></TD>
						<TD width="153">从
							<asp:TextBox id="startDate" runat="server"></asp:TextBox></TD>
						<TD width="153">到
							<asp:TextBox id="endDate" runat="server"></asp:TextBox></TD>
						<TD>
							<asp:Button id="Button" runat="server" Text="选择" OnClick="Button_Click"></asp:Button></TD>
						<TD> 输入日期格式：2005-12-23</TD>
					</TR>
				</TABLE>
				<br/>
								...
								<DIV class="listView" id="ContentList" onkeyup="ContentList_OnKeyup();" align="center">
									<asp:datagrid id="DateGridList" runat="server" CssClass="item" HeaderStyle-CssClass="headerTable"
										...
										<Columns>
											...
											<asp:BoundColumn HeaderText="用户名" HeaderStyle-CssClass="author"></asp:BoundColumn>
											<asp:BoundColumn HeaderText="作者" HeaderStyle-CssClass="author"></asp:BoundColumn>
											<asp:BoundColumn HeaderText="文章数量" HeaderStyle-CssClass="submitdate"></asp:BoundColumn>
										</Columns>
									</asp:datagrid></DIV>
							</DIV>
						</TD>
